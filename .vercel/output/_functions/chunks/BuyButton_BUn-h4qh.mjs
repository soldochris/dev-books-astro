import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, a as renderComponent, b as createAstro } from './astro/server_B2jy8AqU.mjs';
import 'kleur/colors';
import 'clsx';
...
}, "/Users/christiansoldevilla/Dev/astro-course/dev-books/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(url, "href")} title="comprar libro" target="_blank" rel="noopener noreferrer" class="text-balance inline-flex gap-2 items-center bg-yellow-400 hover:bg-yellow-500 active:bg-yellow-600 text-black font-bold py-2 px-4 rounded-lg border border-yellow-500 transition duration-200 ease-in-out hover:scale-105 jus text-center">
Comprar en Amazon ${countryName} ${renderComponent($$result, "AmazonLogo", $$AmazonLogo, {})} </a>`;
}, "/Users/christiansoldevilla/Dev/astro-course/dev-books/src/components/BuyButton.astro", void 0);

const $$file = "/Users/christiansoldevilla/Dev/astro-course/dev-books/src/components/BuyButton.astro";
const $$url = undefined;
